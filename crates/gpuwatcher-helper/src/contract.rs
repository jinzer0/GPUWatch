...
pub const HELPER_CONTRACT: &[HelperContractEntry] = &[
    ...
    HelperContractEntry {
        frontend_api: Some("listWatchRules"),
        helper_action: HelperAction::ListWatchRules,
        visibility: ActionVisibility::Renderer,
        electron_preload_method: Some("listWatchRules"),
        timeout_class: TimeoutClass::Local10s,
        db_mutation: DbMutation::None,
        polling_overlap_key: PollingOverlapKey::None,
        fallback_behavior: "Return an empty array when the server has no configured GPU availability watches.",
        notes: "Reads GPU availability watch rules for one server.",
    },
    HelperContractEntry {
        frontend_api: Some("saveGpuAvailableWatch"),
        helper_action: HelperAction::SaveGpuAvailableWatch,
        visibility: ActionVisibility::Renderer,
        electron_preload_method: Some("saveGpuAvailableWatch"),
        timeout_class: TimeoutClass::Local10s,
        db_mutation: DbMutation::WatchRulesWrite,
        polling_overlap_key: PollingOverlapKey::ServerId,
        fallback_behavior: "Serialize the watch rule write and reset runtime state when its configuration changes.",
        notes: "Creates or updates one GPU availability watch rule.",
    },
    HelperContractEntry {
        frontend_api: Some("deleteWatchRule"),
        helper_action: HelperAction::DeleteWatchRule,
        visibility: ActionVisibility::Renderer,
        electron_preload_method: Some("deleteWatchRule"),
        timeout_class: TimeoutClass::Local10s,
        db_mutation: DbMutation::WatchRulesDelete,
        polling_overlap_key: PollingOverlapKey::None,
        fallback_behavior: "Serialize the watch rule deletion and return null data.",
        notes: "Deletes a watch rule and its runtime state.",
    },
    HelperContractEntry {
        frontend_api: None,
        helper_action: HelperAction::ConsumeNotificationEvents,
        visibility: ActionVisibility::MainOnly,
        electron_preload_method: None,
        timeout_class: TimeoutClass::Local10s,
        db_mutation: DbMutation::NotificationOutboxConsume,
        polling_overlap_key: PollingOverlapKey::None,
